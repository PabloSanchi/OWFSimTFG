...
namespace UnityTemplateProjects
{
    public class SimpleCameraController : MonoBehaviour
    {
        ...
        private Hashtable keyDirections = new Hashtable()
        {
        ...
        private Vector3 GetInputTranslationDirection()
        {
            ...
            foreach (DictionaryEntry entry in keyDirections)
            {
                KeyCode key = (KeyCode)entry.Key;
                Vector3 value = (Vector3)entry.Value;
                if (Input.GetKey(key))
                {
                    direction += value * MOVEMENT_SPEED;
                }
            }
            return direction;
        }
        ...
        //     {
        //         direction += Vector3.forward * 3;
        //     }
        //     if (Input.GetKey(KeyCode.S))
        //     {
        //         direction += Vector3.back * 3;
        //     }
