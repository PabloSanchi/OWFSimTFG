...
public class WavesSettings : ScriptableObject
{
    ...
    public void UpdateWindSpeed(float windSpeed) {
        local.windSpeed = windSpeed;
    }

    public void UpdateWindDirection(float windDirection) {
        local.windDirection = windDirection;
    }

    public void UpdateSwellDirection(float swellDirection) {
        swell.windDirection = swellDirection;
    }

    public void UpdateSwell(float swellInput) {
        swell.swell = swellInput;
    }

    public float GetWindSpeed() {
        return local.windSpeed;
    }

    public float GetWindDirection() {
        return local.windDirection;
    }
